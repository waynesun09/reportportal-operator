...
User could deploy with crd and create CR instance.
    ...
    $ make install
    $ make deploy IMG=quay.io/waynesun09/rp5-operator:v0.0.7
    ...
    reportportal-operator.v0.0.7-8c9f6475f                                 2020-09-17T13:08:38Z
    ...
    reportportal-operator.v0.0.7-default-7c9bd8f688   Role/reportportal-operator.v0.0.7-default-7c9bd8f688   131m
    $ oc get clusterrolebindings |grep reportportal
    reportportal-operator.v0.0.7-8c9f6475f                                           ClusterRole/reportportal-operator.v0.0.7-8c9f6475f                                 131m
