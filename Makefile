...
IMAGE_TAG_BASE ?= reportportal.io/reportportal-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.6.2/ansible-operator_$(OS)_$(ARCH) ;\
